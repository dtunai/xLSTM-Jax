...
output, new_hidden_state = s_lstm.apply(params, seq, hidden_state)

print("Output shape:", output.shape)
print("New hidden state shapes:", [h.shape for h in new_hidden_state])
